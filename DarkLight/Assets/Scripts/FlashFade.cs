...
public class FlashFade : MonoBehaviour
{
	...
	[SerializeField] Color flashColor = new Color(0.92f, 0.8f, 0.05f, 0.1f);	//The color to flash the image (default is red)
	[SerializeField] float flashSpeed = 20f;								//How fast to flash the image
